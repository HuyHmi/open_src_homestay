...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 08, 2025 at 04:15 AM
...
(14, 'recep.svg', 'Lễ tân', 'Đội ngũ lễ tân chuyên nghiệp 24/7, sẵn sàng hỗ trợ bạn trong mọi nhu cầu từ đặt tour, thuê xe đến hướng dẫn tham quan.'),
(15, 'xedap.svg', 'Thuê xe đạp', 'Dịch vụ cho thuê xe đạp thuận tiện, giúp bạn khám phá từng góc phố Nha Trang một cách chậm rãi và đầy thú vị.'),
...
(19, 'school.svg', 'Địa điểm', 'King Homestay tọa lạc tại khu vực Đồi La San – gần Đại học Nha Trang, chỉ vài phút là bạn có thể đến biển hoặc trung tâm thành phố. Khu vực yên tĩnh, an ninh tốt, thuận tiện cho việc nghỉ dưỡng hoặc công tác.');
